 ...
 *----------------------------------------------------------------------------*/
/* Exceptions */
__NO_RETURN void NMI_Handler            (void) __attribute__ ((noreturn, weak, alias("Default_Handler")));
__NO_RETURN void HardFault_Handler      (void) __attribute__ ((weak, alias("Default_Handler")));
...
__NO_RETURN void CAN3_TX_IRQHandler            (void) __attribute__ ((weak, alias("Default_Handler")));
__NO_RETURN void CAN3_RX0_IRQHandler           (void) __attribute__ ((weak, alias("Default_Handler")));
__NO_RETURN void CAN3_RX1_IRQHandler           (void) __attribute__ ((weak, alias("Default_Handler")));
__NO_RETURN void CAN3_SCE_IRQHandler           (void) __attribute__ ((weak, alias("Default_Handler")));
