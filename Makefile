#
# makefile for PCAN-Router Pro FD SDK based on
#
...
CSRC += $(SRC_FOLDER)/startup_router_pro_fd.c
CSRC += $(SRC_FOLDER)/system_router_pro_fd.c
CSRC += $(SRC_FOLDER)/main.c
CSRC += $(SRC_FOLDER)/can_user.c

CSRC += $(SRC_FOLDER)/hardware.c
CSRC += $(SRC_FOLDER)/can.c
CSRC += $(SRC_FOLDER)/eeprom.c
CSRC += $(SRC_FOLDER)/RTX_Config.c
CSRC += $(SRC_FOLDER)/rtx_lib.c
...
CSRC += ./lwip-2.1.2/src/core/ipv4/dhcp.c
CSRC += ./lwip-2.1.2/src/core/ipv4/etharp.c
CSRC += ./lwip-2.1.2/src/core/ipv4/icmp.c
CSRC += ./lwip-2.1.2/src/core/ipv4/ip4.c
CSRC += ./lwip-2.1.2/src/core/ipv4/ip4_addr.c
...
CSRC += ./lwip-2.1.2/src/core/memp.c
CSRC += ./lwip-2.1.2/src/core/pbuf.c
CSRC += ./lwip-2.1.2/src/core/timeouts.c
CSRC += ./lwip-2.1.2/src/core/def.c
CSRC += ./lwip-2.1.2/src/core/netif.c
CSRC += ./lwip-2.1.2/src/core/tcp_out.c
CSRC += ./lwip-2.1.2/src/core/tcp_in.c
CSRC += ./lwip-2.1.2/src/core/tcp.c
CSRC += ./lwip-2.1.2/src/core/ip.c
CSRC += ./lwip-2.1.2/src/core/udp.c

CSRC += ./lwip-2.1.2/src/netif/ethernet.c
...
INC_FOLDERS += ./inc
INC_FOLDERS += ./lwip-2.1.2/src/include
...
#CDEFS =  -DARMCM7_DP -DPCAN_ROUTER_PRO_FD=1 -DGCC=1 -D__USE_CMSIS -DSTM32F765xx
CDEFS =  -DARMCM7_DP -DPCAN_ROUTER_PRO_FD=1 -DGCC=1 -D__USE_CMSIS -DSTM32F765xx -D__FPU_PRESENT=1
...
LDFLAGS += -Tpcan_router_pro_fd.ld

# add project specific libs
PRJLIBS = $(LIB_FOLDER)/libRTX_CM4F.a
...
ALL_CFLAGS = -mcpu=$(MCU) -mthumb -mfloat-abi=hard -mfpu=fpv5-d16 -I. $(CFLAGS) $(GENDEPFLAGS)
ALL_ASFLAGS = -mcpu=$(MCU) -mthumb -mfloat-abi=hard -mfpu=fpv5-d16 -I. -x assembler-with-cpp $(ASFLAGS)
